        ...
        if self.engine:
            try:
                ...
                prompt = (
                    ...
                    f"   - 'main': A story-driven news report. It MUST be at least 400 words and at most 700 words for a 3-5 minute video. Follow this structure exactly:\\n"
                    f"     1. HOOK (0-5s): {self.RETENTION_BLUEPRINT['main_structure'][0]}\\n"
                    f"     2. {self.RETENTION_BLUEPRINT['main_structure'][1]}\\n"
                    f"     3. {self.RETENTION_BLUEPRINT['main_structure'][2]}\\n"
                    f"     4. {self.RETENTION_BLUEPRINT['main_structure'][3]}\\n"
                    f"     5. {self.RETENTION_BLUEPRINT['main_structure'][4]}\\n"
                    f"     6. {self.RETENTION_BLUEPRINT['main_structure'][5]}\\n"
                    f"     7. {self.RETENTION_BLUEPRINT['main_structure'][6]}\\n"
                    f"     8. {self.RETENTION_BLUEPRINT['main_structure'][7]}\\n"
                    ...
                    f"   SHORTS RULE: ALL shorts MUST start with the most surprising/controversial statement in the FIRST 2 SECONDS. No introductions. No 'Breaking news from our homeland.' Go straight to the hook. This is critical for short-form retention.\n"
